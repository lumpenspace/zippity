...
class TestTodoUtils(object):
  ...
  class TestTodoUtils(object):
    ...
    def test_search_todos_in_file_with_todos(self):
      ...
      file_data = FileData(location=self.get_file('file_with_todos.py'), mimetype='text/x-python', name='file_with_todos.py')
    ...
    def test_search_todos_in_file_without_todos(self):
      ...
      file_data = FileData(location=self.get_file('file_without_todos.txt'), mimetype='text/plain', name='file_without_todos.txt')
